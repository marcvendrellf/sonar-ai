...
export const goldenState: InvestmentCommitteeState = {
  ...
  marketContext: {
    ...
    candidateOpportunities: [
      { symbol: "NVDA", name: "Nvidia", sector: "Semiconductors", rationale: "AI infrastructure demand has strongest evidence support.", evidenceIds: ["ev_capex", "ev_nvda_fund"], qualityScore: 90, valuationScore: 55, catalystScore: 85, downsideRiskScore: 60, timeHorizon: "6-12 months", bullCase: "AI capex remains strong.", baseCase: "Growth moderates but persists.", bearCase: "Capex cycle reverses.", invalidationConditions: ["Two quarters of falling datacenter demand"] },
      { symbol: "SIEGY", name: "Siemens Energy", sector: "Energy", rationale: "Grid power is the under-priced second-order dependency.", evidenceIds: ["ev_power_demand", "ev_siemens_fund"], qualityScore: 78, valuationScore: 70, catalystScore: 80, downsideRiskScore: 40, timeHorizon: "12-24 months", bullCase: "Grid investment accelerates.", baseCase: "Backlog converts steadily.", bearCase: "Project execution disappoints.", invalidationConditions: ["Backlog cancellation trend"] },
    ],
