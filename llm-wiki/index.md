...
- [Technical reference pack](technical-reference-pack.md): monorepo layout, Next.js, shadcn, animation, graph, Cala, eToro, and MVP investment-committee architecture.
