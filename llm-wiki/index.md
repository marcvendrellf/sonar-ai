...
- [Technical reference pack](technical-reference-pack.md): monorepo layout, Next.js, shadcn, animation, graph, Cala, Alpaca, and MVP investment-committee architecture.
