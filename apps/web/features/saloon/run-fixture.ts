...
export const agents: readonly Agent[] = [
  {
    ...
    name: "Market Context",
    initials: "MC",
    role: "Reads events and market context",
  ...
  },
  {
    ...
    initials: "FA",
    role: "Studies companies and relationships",
  ...
  },
  {
    ...
    initials: "PM",
    role: "Proposes the allocation",
    idleTask: "Waiting for sourced research",
    seat: 2,
    color: "#397567",
  },
  {
    ...
    name: "Bear / Critic",
    initials: "BC",
    role: "Challenges the recommendation",
  ...
  },
  {
    ...
    name: "Report Writer",
    initials: "RW",
    role: "Records the final decision",
    idleTask: "Waiting for the human decision",
    seat: 5,
    color: "#39485a",
  },
]
...
export const trace: readonly TraceEntry[] = [
  ...
  },
  {
    ...
    source: "SRC-03",
    task: "Drafting the allocation case",
  },
  {
    id: "t09",
    at: 45000,
  ...
  },
  {
    ...
    agent: "trader",
    kind: "gate",
    text: "Report drafting is blocked until risk checks pass and a human decision is recorded.",
    system: "gate",
    states: { trader: "blocked" },
    task: "Waiting for the final decision",
  },
  {
    id: "t13",
    at: 58000,
  ...
  },
  {
    ...
    agent: "trader",
    kind: "trade",
    text: "Received the approved paper-ledger result: sell €41,500 NOD.OL at fixture price 118.40.",
    system: "paper only",
    task: "Recording the final decision",
  },
  {
    id: "t20",
    at: 69000,
...
export const receiptAnswers: readonly ReceiptAnswer[] = [
  {
    ...
    text: "Turnover for this event would have reached 7.1% against a 5.0% cap, so the Risk Officer resized the sell from €62,000 to €41,500. The unresized order is on file as the rejected alternative.",
    cites: "RC-03",
  },
  {
    id: "alternative",
  ...
  },
  {
    ...
    text: "The paper ledger and Report Writer remained blocked until every deterministic check ran and the final decision was recorded.",
    cites: "SR-042",
  },
  {
    id: "conviction",
    keywords: ["conviction", "confidence", "old", "stale", "age", "objection", "skeptic"],
    text: "Conviction was reduced because the supporting filing is 11 months old and no newer filing exists in the fixture set. The Bear / Critic objection remains in the receipt.",
    cites: "SRC-02",
  },
]
